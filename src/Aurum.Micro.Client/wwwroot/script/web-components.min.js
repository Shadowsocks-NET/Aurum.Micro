...
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */
function mh(t,e,i,o){var s,n=arguments.length,r=n<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(n<3?s(r):n>3?s(e,i,r):s(e,i))||r);return n>3&&r&&Object.defineProperty(e,i,r),r}class bh{constructor(t,e){this.cache=new WeakMap,this.ltr=t,this.rtl=e}bind(t){this.attach(t)}unbind(t){const e=this.cache.get(t);e&&An.unsubscribe(e)}attach(t){const e=this.cache.get(t)||new vh(this.ltr,this.rtl,t),i=An.getValueFor(t);An.subscribe(e),e.attach(i),this.cache.set(t,e)}}class vh{constructor(t,e,i){this.ltr=t,this.rtl=e,this.source=i,this.attached=null}handleChange({target:t,token:e}){this.attach(e.getValueFor(this.source))}attach(t){this.attached!==this[t]&&(null!==this.attached&&this.source.$fastController.removeStyles(this.attached),this.attached=this[t],null!==this.attached&&this.source.$fastController.addStyles(this.attached))}}const yh="0 0 2px rgba(0, 0, 0, 0.14)",xh="0 calc(var(--elevation) * 0.5px) calc((var(--elevation) * 1px)) rgba(0, 0, 0, 0.2)",$h=`box-shadow: 0 0 2px rgba(0, 0, 0, 0.14), ${xh};`,wh=$o.create({name:"elevation-shadow",cssCustomPropertyName:null}).withDefault({evaluate:(t,e,i)=>{let o=.12,s=.14;e>16&&(o=.2,s=.24);return`${`0 0 2px rgba(0, 0, 0, ${o})`}, ${`0 calc(${e} * 0.5px) calc((${e} * 1px)) rgba(0, 0, 0, ${s})`}`}}),kh=$o.create("elevation-shadow-card-rest-size").withDefault(4),Ch=$o.create("elevation-shadow-card-hover-size").withDefault(8),Fh=$o.create("elevation-shadow-card-active-size").withDefault(0),Ih=$o.create("elevation-shadow-card-focus-size").withDefault(8),Th=$o.create("elevation-shadow-card-rest").withDefault(t=>wh.getValueFor(t).evaluate(t,kh.getValueFor(t))),Dh=$o.create("elevation-shadow-card-hover").withDefault(t=>wh.getValueFor(t).evaluate(t,Ch.getValueFor(t))),Vh=$o.create("elevation-shadow-card-active").withDefault(t=>wh.getValueFor(t).evaluate(t,Fh.getValueFor(t))),Sh=$o.create("elevation-shadow-card-focus").withDefault(t=>wh.getValueFor(t).evaluate(t,Ih.getValueFor(t))),Rh=$o.create("elevation-shadow-tooltip-size").withDefault(16),Eh=$o.create("elevation-shadow-tooltip").withDefault(t=>wh.getValueFor(t).evaluate(t,Rh.getValueFor(t))),Oh=$o.create("elevation-shadow-flyout-size").withDefault(32),Ah=$o.create("elevation-shadow-flyout").withDefault(t=>wh.getValueFor(t).evaluate(t,Oh.getValueFor(t))),Lh=$o.create("elevation-shadow-dialog-size").withDefault(128),zh=$o.create("elevation-shadow-dialog").withDefault(t=>wh.getValueFor(t).evaluate(t,Lh.getValueFor(t))),Hh=(t,e,i="",o="")=>Dt`
    ${eo("inline-flex")} :host{position:relative;box-sizing:border-box;font-family:${qn};outline:none;font-size:${_n};line-height:${Gn};height:calc(${ah} * 1px);min-width:calc(${ah} * 1px);color:${Dl};border-radius:calc(${Bn} * 1px);fill:currentcolor;cursor:pointer}:host .control{background:padding-box linear-gradient(${Ga},${Ga}),border-box ${Bl};border:calc(${jn} * 1px) solid transparent;flex-grow:1;box-sizing:border-box;display:inline-flex;justify-content:center;align-items:center;padding:0 calc((10 + (${Mn} * 2 * ${Pn})) * 1px);white-space:nowrap;outline:none;text-decoration:none;color:inherit;border-radius:inherit;fill:inherit;cursor:inherit;font-family:inherit}.control,.end,.start{font:inherit}.control.icon-only{padding:0;line-height:0}:host .control${i}:hover{background:padding-box linear-gradient(${Wa},${Wa}),border-box ${Nl}}:host .control${i}:active{background:padding-box linear-gradient(${Ka},${Ka}),border-box ${jl}}:host .control:${io}{border-color:${ac} !important;box-shadow:0 0 0 calc((${Un} - ${jn}) * 1px) ${ac} inset !important}:host .control${o}{background:padding-box linear-gradient(${Ga},${Ga}),border-box ${Ll}}.control::-moz-focus-inner{border:0}.content{pointer-events:none}.start,.end{display:flex;pointer-events:none}.start{margin-inline-end:11px}.end{margin-inline-start:11px}`.withBehaviors(Ji(Dt`
        :host .control{background:${Ns.ButtonFace};border-color:${Ns.ButtonText};color:${Ns.ButtonText};fill:currentcolor}:host(:not([disabled])) .control:hover,:host .control${i}:hover,.control${i}:hover{forced-color-adjust:none;background:${Ns.Highlight};color:${Ns.HighlightText}}.control:${io},:host .control:${io},:host(:${io}) .control{forced-color-adjust:none;background:${Ns.ButtonFace};border-color:${Ns.Highlight} !important;box-shadow:0 0 0 calc((${Un} - ${jn}) * 1px) ${Ns.Highlight} !important}:host([href]) .control{background:${Ns.ButtonFace};border-color:${Ns.LinkText};color:${Ns.LinkText};fill:currentcolor}:host([href]) .control:hover,:host(.neutral[href]) .control:hover{background:${Ns.LinkText};border-color:${Ns.LinkText} !important;color:${Ns.HighlightText};fill:currentcolor}:host([href]) .control:${io}{forced-color-adjust:none;border-color:${Ns.LinkText} !important;box-shadow:0 0 0 calc((${Un} - ${jn}) * 1px) ${Ns.LinkText} !important}`)),Ph=(t,e,i="",o="")=>Dt`
    :host .control{background:padding-box linear-gradient(${Ia},${Ia}),border-box ${Na};color:${Ra}}:host .control${i}:hover{background:padding-box linear-gradient(${Ta},${Ta}),border-box ${ja};color:${Ea}}:host .control${i}:active{background:padding-box linear-gradient(${Da},${Da}),border-box ${Ua};color:${Oa}}:host .control:${io}{box-shadow:0 0 0 calc((${Un} - ${jn}) * 1px) ${ac} inset,0 0 0 calc(((${Un} + ${jn}) - ${jn}) * 1px) ${cc} inset !important}:host .control${o}{background:${Ia}}`.withBehaviors(Ji(Dt`
        :host .control{forced-color-adjust:none;background:${Ns.Highlight};color:${Ns.HighlightText}}:host .control${i}:hover,:host .control${i}:active{background:${Ns.HighlightText};border-color:${Ns.Highlight};color:${Ns.Highlight}}:host .control:${io}{background:${Ns.Highlight};box-shadow:0 0 0 calc((${Un} - ${jn}) * 1px) ${Ns.Highlight} inset,0 0 0 calc(((${Un} + ${jn}) - ${jn}) * 1px) ${Ns.HighlightText} inset !important}:host([href]) .control{background:${Ns.LinkText};color:${Ns.HighlightText}}:host([href]) .control:hover{background:${Ns.ButtonFace};border-color:${Ns.LinkText};box-shadow:none;color:${Ns.LinkText};fill:currentcolor}:host([href]) .control:${io}{background:${Ns.LinkText};box-shadow:0 0 0 calc((${Un} - ${jn}) * 1px) ${Ns.LinkText} inset,0 0 0 calc(((${Un} + ${jn}) - ${jn}) * 1px) ${Ns.HighlightText} inset !important;color:${Ns.HighlightText};fill:currentcolor}`)),Mh=(t,e,i="",o="")=>Dt`
    :host{height:auto;font-family:inherit;font-size:inherit;line-height:inherit;min-width:0}:host .control{display:inline;padding:0;background:transparent;border:none;box-shadow:none;line-height:1;text-decoration:underline 1px}:host .control:not([href]){background:transparent}:host .control${i}{background:transparent;color:${za}}:host .control${i}:hover{background:transparent;color:${Ha};text-decoration:none}:host .control${i}:active{background:transparent;color:${Pa};text-decoration:none}:host .control:${io}{box-shadow:0 0 0 calc(${Un} * 1px) ${ac} !important}:host .control${o}{background:transparent}`.withBehaviors(Ji(Dt`
      :host .control${i}:hover{color:${Ns.Highlight};fill:currentcolor}:host .control:${io}{color:${Ns.LinkText}}`)),Bh=(t,e,i="",o="")=>Dt`
    :host{color:${za}}:host .control{background:${vl}}:host .control${i}:hover{background:${yl};color:${Ha}}:host .control${i}:active{background:${xl};color:${Pa}}:host .control${o}{background:${vl}}`.withBehaviors(Ji(Dt`
        :host .control{border-color:${Ns.ButtonFace};color:${Ns.ButtonText}}:host .control${i}:hover,:host .control${i}:active,:host .control:${io}{border-color:${Ns.Highlight};background:${Ns.Highlight};box-shadow:none;color:${Ns.HighlightText}}:host([href]) .control{border-color:${Ns.ButtonFace};color:${Ns.LinkText}}:host([href]) .control:hover,:host([href]) .control:${io}{background:${Ns.ButtonFace};box-shadow:none;color:${Ns.LinkText}}`)),Nh=(t,e,i="",o="")=>Dt`
    :host .control{background:transparent !important;border-color:${Ll}}:host .control${i}:hover{border-color:${zl}}:host .control${i}:active{border-color:${Hl}}:host .control${o}{background:transparent !important;border-color:${Ll}}`.withBehaviors(Ji(Dt`
        :host .control${o}{border-color:${Ns.ButtonText}}:host .control${i}:hover{border-color:${Ns.Highlight};color:${Ns.ButtonText}}:host([href]){border-color:${Ns.LinkText}}:host([href]) .control:hover{box-shadow:0 0 0 calc((${Un} - ${jn}) * 1px) ${Ns.LinkText};color:${Ns.LinkText}}`)),jh=(t,e,i="",o="")=>Dt`
    :host .control{background:${vl}}:host .control${i}:hover{background:${yl}}:host .control${i}:active{background:${xl}}:host .control${o}{background:${vl}}`.withBehaviors(Ji(Dt`
        :host .control{background:${Ns.ButtonFace};border-color:${Ns.ButtonFace};color:${Ns.ButtonText};fill:currentcolor}:host .control${i}:hover,:host .control${i}:active,:host .control:${io}{background:${Ns.Highlight};border-color:${Ns.Highlight};box-shadow:none !important;color:${Ns.HighlightText};fill:currentcolor}:host([href]) .control{border-color:${Ns.ButtonFace};color:${Ns.LinkText}}:host([href]) .control:hover,:host([href]) .control:${io}{background:${Ns.LinkText};border-color:${Ns.LinkText};box-shadow:none !important;color:${Ns.HighlightText};fill:currentcolor}`)),Uh=$o.create("input-placeholder-rest").withDefault(t=>{const e=Ya.getValueFor(t);return El.getValueFor(t).evaluate(t,e.evaluate(t).rest)}),qh=$o.create("input-placeholder-hover").withDefault(t=>{const e=Ya.getValueFor(t);return El.getValueFor(t).evaluate(t,e.evaluate(t).hover)}),_h=$o.create("input-filled-placeholder-rest").withDefault(t=>{const e=ul.getValueFor(t);return El.getValueFor(t).evaluate(t,e.evaluate(t).rest)}),Gh=$o.create("input-filled-placeholder-hover").withDefault(t=>{const e=ul.getValueFor(t);return El.getValueFor(t).evaluate(t,e.evaluate(t).hover)}),Wh=(t,e,i)=>Dt`
  :host{font-family:${qn};font-size:${_n};line-height:${Gn};color:${Dl};fill:currentcolor;outline:none;user-select:none;position:relative}${i}{box-sizing:border-box;position:relative;color:inherit;background:padding-box linear-gradient(${Qa},${Qa}),border-box ${Wl};border:calc(${jn} * 1px) solid transparent;border-radius:calc(${Bn} * 1px);height:calc(${ah} * 1px);font-family:inherit;font-size:inherit;line-height:inherit}.control{width:100%}.control:hover,.control:${io},.control:disabled,.control:active{outline:none}.label{display:block;color:${Dl};cursor:pointer;font-size:${_n};line-height:${Gn};margin-bottom:4px}.label__hidden{display:none;visibility:hidden}:host(:hover:not([disabled]):not(:focus-within)) ${i}{background:padding-box linear-gradient(${Za},${Za}),border-box ${Kl}}:host(:not([disabled]):focus-within) ${i}{background:padding-box linear-gradient(${tl},${tl}),border-box ${Wl}}.control::placeholder{color:${Uh}}:host(:hover:not([disabled]):not(:focus-within)) .control::placeholder{color:${qh}}:host([disabled]) ${i},:host([readonly]) ${i},:host([disabled]) .label,:host([readonly]) .label,:host([disabled]) .control,:host([readonly]) .control{cursor:${"not-allowed"}}:host([disabled]){opacity:${Ln}}:host([disabled]) ${i}{background:padding-box linear-gradient(${Qa},${Qa}),border-box ${Ll}}`,Kh=(t,e,i)=>Dt`
  :host(:not([disabled]):active)::after{left:50%;width:40%;transform:translateX(-50%);border-bottom-left-radius:0;border-bottom-right-radius:0}:host(:not([disabled]):focus-within)::after{left:0;width:100%;transform:none}:host(:not([disabled]):active)::after,:host(:not([disabled]):focus-within:not(:active))::after{content:'';position:absolute;height:calc(${Un} * 1px);bottom:0;border-bottom:calc(${Un} * 1px) solid ${Ia};border-bottom-left-radius:calc(${Bn} * 1px);border-bottom-right-radius:calc(${Bn} * 1px);z-index:2;transition:all 300ms cubic-bezier(0.1,0.9,0.2,1)}`,Xh=(t,e,i)=>Dt`
  :host ${i}{background:${pl};border-color:transparent}:host(:hover:not([disabled]):not(:focus-within)) ${i}{background:${gl};border-color:transparent}.control::placeholder{color:${_h}}:host(:hover:not([disabled]):not(:focus-within)) .control::placeholder{color:${Gh}}:host(:focus-within:not([disabled])) ${i}{border-color:transparent;box-shadow:none}`,Yh=(t,e,i)=>Dt`
  :host ${i}{background:${Ns.Field};border-color:${Ns.FieldText}}:host(:hover:not([disabled]):not(:focus-within)) ${i}{border-color:${Ns.Highlight}}:host(:not([disabled]):active)::after,:host(:not([disabled]):focus-within:not(:active))::after{border-bottom-color:${Ns.Highlight}}:host([disabled]){opacity:1}:host([disabled]) ${i}{border-color:${Ns.GrayText}}:host([disabled]) ::placeholder,:host([disabled]) ::-webkit-input-placeholder,:host([disabled]) .label{color:${Ns.GrayText};fill:currentcolor}`,Qh=(t,e,i)=>Dt`
  :host ${i},:host(:hover:not([disabled])) ${i},:host(:active:not([disabled])) ${i},:host(:focus-within:not([disabled])) ${i}{background:${Ns.Field};border-color:${Ns.FieldText}}:host(:not([disabled]):active)::after,:host(:not([disabled]):focus-within:not(:active))::after{border-bottom-color:${Ns.Highlight}}:host([disabled]) ${i}{border-color:${Ns.GrayText}}`;function Zh(t,e){return new to("appearance",t,e)}const Jh=(t,e)=>Dt`
    :host .control:not([href]){cursor:default}${Hh(0,0,"[href]",":not([href])")}
  `.withBehaviors(Zh("accent",Ph(0,0,"[href]",":not([href])")),Zh("hypertext",Mh(0,0,"[href]",":not([href])")),Zh("lightweight",Bh(0,0,"[href]",":not([href])")),Zh("outline",Nh(0,0,"[href]",":not([href])")),Zh("stealth",jh(0,0,"[href]",":not([href])")));class td extends ai{appearanceChanged(t,e){t!==e&&(this.classList.add(e),this.classList.remove(t))}connectedCallback(){super.connectedCallback(),this.appearance||(this.appearance="neutral")}defaultSlottedContentChanged(){const t=this.defaultSlottedContent.filter(t=>t.nodeType===Node.ELEMENT_NODE);1===t.length&&t[0]instanceof SVGElement?this.control.classList.add("icon-only"):this.control.classList.remove("icon-only")}}mh([ft],td.prototype,"appearance",void 0);const ed=Jh,id=td.compose({baseName:"anchor",baseClass:ai,template:ni,styles:Jh,shadowOptions:{delegatesFocus:!0}}),od=(t,e)=>Dt`
  :host{contain:layout;display:block}`,sd=hi.compose({baseName:"anchored-region",template:(t,e)=>nt`<template class="${t=>t.initialLayoutComplete?"loaded":""}">${Nt(t=>t.initialLayoutComplete,nt`<slot></slot>`)}</template>`,styles:od}),nd=od,rd=(t,e)=>Dt`
    ${eo("inline-block")} :host{box-sizing:border-box;font-family:${qn};font-size:${Wn};line-height:${Kn}}.control{border-radius:calc(${Bn} * 1px);padding:calc(((${Mn} * 0.5) - ${jn}) * 1px) calc((${Mn} - ${jn}) * 1px);border:calc(${jn} * 1px) solid transparent}:host(.lightweight) .control{background:transparent;color:${Dl};font-weight:600}:host(.accent) .control{background:${Ia};color:${Ra}}:host(.neutral) .control{background:${pl};color:${Dl}}:host([circular]) .control{border-radius:100px;min-width:calc(${Kn} - calc(${Mn} * 1px));display:flex;align-items:center;justify-content:center}`;class ad extends di{constructor(){super(...arguments),this.appearance="lightweight"}appearanceChanged(t,e){t!==e&&d.queueUpdate(()=>{this.classList.add(e),this.classList.remove(t)})}}mh([ft({mode:"fromView"})],ad.prototype,"appearance",void 0);const ld=ad.compose({baseName:"badge",baseClass:di,template:(t,e)=>nt`<template class="${t=>t.circular?"circular":""}"><div class="control" part="control" style="${t=>t.generateBadgeStyle()}"><slot></slot></div></template>`,styles:rd}),cd=rd,hd=(t,e)=>Dt`
  ${eo("inline-block")} :host{box-sizing:border-box;font-family:${qn};font-size:${_n};line-height:${Gn}}.list{display:flex}`,dd=pi.compose({baseName:"breadcrumb",template:(t,e)=>nt`<template role="navigation"><div role="list" class="list" part="list"><slot ${Qt({property:"slottedBreadcrumbItems",filter:Kt()})}></slot></div></template>`,styles:hd}),ud=hd,pd=(t,e)=>Dt`
    ${eo("inline-flex")} :host{background:transparent;color:${Dl};fill:currentcolor;box-sizing:border-box;font-family:${qn};font-size:${_n};line-height:${Gn};min-width:calc(${ah} * 1px);border-radius:calc(${Bn} * 1px);outline:none}.listitem{display:flex;align-items:center;border-radius:inherit}.control{position:relative;align-items:center;box-sizing:border-box;color:inherit;fill:inherit;cursor:pointer;display:flex;outline:none;text-decoration:none;white-space:nowrap;border-radius:inherit}.control:hover{color:${Vl}}.control:active{color:${Sl}}.control:${io}::after{content:'';position:absolute;inset:calc(${jn} * -1px);box-shadow:0 0 0 calc(${Un} * 1px) ${ac} inset;border-radius:inherit}:host(:not([href])),:host([aria-current]) .control{color:${Dl};fill:currentcolor;cursor:default}.start{display:flex;margin-inline-end:6px}.end{display:flex;margin-inline-start:6px}.separator{display:flex}`.withBehaviors(Ji(Dt`
        :host(:not([href])),.start,.end,.separator{background:${Ns.ButtonFace};color:${Ns.ButtonText};fill:currentcolor}.separator{fill:${Ns.ButtonText}}:host([href]){forced-color-adjust:none;background:${Ns.ButtonFace};color:${Ns.LinkText}}:host([href]) .control:hover{background:${Ns.LinkText};color:${Ns.HighlightText};fill:currentcolor}:host([href]) .control:${io}::after{box-shadow:0 0 0 calc(${Un} * 1px) ${Ns.LinkText} inset}`)),gd=ui.compose({baseName:"breadcrumb-item",template:(t,e)=>nt`<div role="listitem" class="listitem" part="listitem">${Nt(t=>t.href&&t.href.length>0,nt` ${ni(0,e)} `)} ${Nt(t=>!t.href,nt` ${ie(0,e)}<slot></slot>${ee(0,e)} `)} ${Nt(t=>t.separator,nt`<span class="separator" part="separator" aria-hidden="true"><slot name="separator">${e.separator||""}</slot></span>`)}</div>`,styles:pd,shadowOptions:{delegatesFocus:!0},separator:'\n    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg">\n      <path d="M4.65 2.15a.5.5 0 000 .7L7.79 6 4.65 9.15a.5.5 0 10.7.7l3.5-3.5a.5.5 0 000-.7l-3.5-3.5a.5.5 0 00-.7 0z"/>\n    </svg>\n  '}),fd=pd,md=(t,e)=>Dt`
    :host([disabled]){opacity:${Ln};cursor:${"not-allowed"}}${Hh(0,0,":not([disabled])","[disabled]")}
  `.withBehaviors(Ji(Dt`
        :host([disabled]){opacity:1}:host([disabled]) .control{border-color:${Ns.GrayText};color:${Ns.GrayText};fill:currentcolor}`),Zh("accent",Dt`
      ${Ph(0,0,":not([disabled])","[disabled]")},`.withBehaviors(Ji(Dt`
            :host([disabled]) .control{background:${Ns.ButtonFace}}`))),Zh("lightweight",Dt`
      ${Bh(0,0,":not([disabled])","[disabled]")},`.withBehaviors(Ji(Dt`
            :host([disabled]) .control{border-color:${Ns.ButtonFace}}`))),Zh("outline",Dt`
      ${Nh(0,0,":not([disabled])","[disabled]")}
      `.withBehaviors(Ji(Dt`
            :host([disabled]) .control{border-color:${Ns.GrayText}}`))),Zh("stealth",Dt`
      ${jh(0,0,":not([disabled])","[disabled]")}
      `.withBehaviors(Ji(Dt`
            :host([disabled]) .control{border-color:${Ns.ButtonFace}}`))));class bd extends xi{appearanceChanged(t,e){t!==e&&(this.classList.add(e),this.classList.remove(t))}connectedCallback(){super.connectedCallback(),this.appearance||(this.appearance="neutral")}defaultSlottedContentChanged(){const t=this.defaultSlottedContent.filter(t=>t.nodeType===Node.ELEMENT_NODE);1===t.length&&t[0]instanceof SVGElement?this.control.classList.add("icon-only"):this.control.classList.remove("icon-only")}}mh([ft],bd.prototype,"appearance",void 0);const vd=bd.compose({baseName:"button",baseClass:xi,template:(t,e)=>nt`<button class="control" part="control" ?autofocus="${t=>t.autofocus}" ?disabled="${t=>t.disabled}" form="${t=>t.formId}" formaction="${t=>t.formaction}" formenctype="${t=>t.formenctype}" formmethod="${t=>t.formmethod}" formnovalidate="${t=>t.formnovalidate}" formtarget="${t=>t.formtarget}" name="${t=>t.name}" type="${t=>t.type}" value="${t=>t.value}" aria-atomic="${t=>t.ariaAtomic}" aria-busy="${t=>t.ariaBusy}" aria-controls="${t=>t.ariaControls}" aria-current="${t=>t.ariaCurrent}" aria-describedby="${t=>t.ariaDescribedby}" aria-details="${t=>t.ariaDetails}" aria-disabled="${t=>t.ariaDisabled}" aria-errormessage="${t=>t.ariaErrormessage}" aria-expanded="${t=>t.ariaExpanded}" aria-flowto="${t=>t.ariaFlowto}" aria-haspopup="${t=>t.ariaHaspopup}" aria-hidden="${t=>t.ariaHidden}" aria-invalid="${t=>t.ariaInvalid}" aria-keyshortcuts="${t=>t.ariaKeyshortcuts}" aria-label="${t=>t.ariaLabel}" aria-labelledby="${t=>t.ariaLabelledby}" aria-live="${t=>t.ariaLive}" aria-owns="${t=>t.ariaOwns}" aria-pressed="${t=>t.ariaPressed}" aria-relevant="${t=>t.ariaRelevant}" aria-roledescription="${t=>t.ariaRoledescription}" ${Bt("control")}>${ie(0,e)}<span class="content" part="content"><slot ${Qt("defaultSlottedContent")}></slot></span>${ee(0,e)}</button>`,styles:md,shadowOptions:{delegatesFocus:!0}}),yd=md,xd=Dt`
.day.disabled::before{transform:translate(-50%,0) rotate(45deg)}`,$d=Dt`
.day.disabled::before{transform:translate(50%,0) rotate(-45deg)}`;class wd extends ki{constructor(){super(...arguments),this.readonly=!0}}mh([ft({converter:ut})],wd.prototype,"readonly",void 0);const kd=wd.compose({baseName:"calendar",template:(t,e)=>{var i;const o=new Date,s=`${o.getMonth()+1}-${o.getDate()}-${o.getFullYear()}`;return nt`<template>${se} ${e.title instanceof Function?e.title(t,e):null!==(i=e.title)&&void 0!==i?i:""}<slot></slot>${Nt(t=>!1===t.readonly,Ai(t,s))} ${Nt(t=>!0===t.readonly,(t=>nt`<div class="days" part="days"><div class="week-days" part="week-days">${Wt(t=>t.getWeekdayText(),nt`<div class="week-day" part="week-day" abbr="${t=>t.abbr}">${t=>t.text}</div>`)}</div>${Wt(t=>t.getDays(),nt`<div class="week">${Wt(t=>t,nt`<div class="${(e,i)=>i.parentContext.parent.getDayClassNames(e,t)}" part="day" aria-label="${(t,e)=>e.parentContext.parent.dateFormatter.getDate(`${t.month}-${t.day}-${t.year}`,{month:"long",day:"numeric"})}"><div class="date" part="${e=>t===`${e.month}-${e.day}-${e.year}`?"today":"date"}">${(t,e)=>e.parentContext.parent.dateFormatter.getDay(t.day)}</div><slot name="${t=>t.month}-${t=>t.day}-${t=>t.year}"></slot></div>`)}</div>`)}</div>`)(s))} ${oe}</template>`},styles:(t,e)=>Dt`
${eo("inline-block")} :host{--calendar-cell-size:calc((${zn} + 2 + ${Pn}) * ${Mn} * 1px);--calendar-gap:2px;font-family:${qn};font-size:${_n};line-height:${Gn};color:${Dl}}.title{padding:calc(${Mn} * 2px);font-weight:600}.days{text-align:center}.week-days,.week{display:grid;grid-template-columns:repeat(7,1fr);grid-gap:var(--calendar-gap);border:0;padding:0}.day,.week-day{border:0;width:var(--calendar-cell-size);height:var(--calendar-cell-size);line-height:var(--calendar-cell-size);padding:0;box-sizing:initial}.week-day{font-weight:600}.day{border:calc(${jn} * 1px) solid transparent;border-radius:calc(${Bn} * 1px)}.interact .day{cursor:pointer}.date{height:100%}.inactive .date,.inactive.disabled::before{color:${Ol}}.disabled::before{content:'';display:inline-block;width:calc(var(--calendar-cell-size) * .8);height:calc(${jn} * 1px);background:currentColor;position:absolute;margin-top:calc(var(--calendar-cell-size) / 2);transform-origin:center;z-index:1}.selected{color:${Ia};border:1px solid ${Ia};background:${ka}}.selected + .selected{border-start-start-radius:0;border-end-start-radius:0;border-inline-start-width:0;padding-inline-start:calc(var(--calendar-gap) + (${jn} + ${Bn}) * 1px);margin-inline-start:calc((${Bn} * -1px) - var(--calendar-gap))}.today.disabled::before{color:${Ra}}.today .date{color:${Ra};background:${Ia};border-radius:50%;position:relative}`.withBehaviors(Ji(Dt`
  ...
  :host{background:${pl};border-color:transparent}:host(:not([disabled]):not([open]):hover){background:${gl};border-color:transparent}:host(:not([disabled]):not([open]):active){background:${fl};border-color:transparent}`.withBehaviors(Ji(Dt`
    ...
    ${eo("inline-flex")} :host{background:padding-box linear-gradient(${Ga},${Ga}),border-box ${Bl};border:calc(${jn} * 1px) solid transparent;border-radius:calc(${Bn} * 1px);box-sizing:border-box;color:${Dl};fill:currentcolor;font-family:${qn};height:calc(${ah} * 1px);position:relative;user-select:none;min-width:250px;vertical-align:top}:host .listbox{box-shadow:${Ah};background:${ka};border-radius:calc(${Nn} * 1px);box-sizing:border-box;display:inline-flex;flex-direction:column;left:0;max-height:calc(var(--max-height) - (${ah} * 1px));padding:calc((${Mn} - ${jn} ) * 1px) 0;overflow-y:auto;position:absolute;width:100%;z-index:1;margin:1px 0;border:calc(${jn} * 1px) solid transparent}:host .listbox[hidden]{display:none}:host .control{align-items:center;box-sizing:border-box;cursor:pointer;display:flex;font-size:${_n};font-family:inherit;min-height:100%;line-height:${Gn};padding:0 calc(${Mn} * 2.25px);width:100%}:host(:not([disabled]):not([open]):hover){background:padding-box linear-gradient(${Wa},${Wa}),border-box ${Nl}}:host(:not([disabled]):not([open]):active){background:padding-box linear-gradient(${Ka},${Ka}),border-box ${jl}}:host(:${io}){border-color:${ac};outline:none;box-shadow:0 0 0 1px inset ${ac}}:host([disabled]){cursor:${"not-allowed"};opacity:${Ln}}:host([disabled]) .control{cursor:${"not-allowed"};user-select:none}:host([open][position='above']) .listbox{bottom:calc((${ah} + ${Mn} * 2) * 1px)}:host([open][position='below']) .listbox{top:calc((${ah} + ${Mn} * 2) * 1px)}.selected-value{font-family:inherit;flex:1 1 auto;text-align:start}.indicator{flex:0 0 auto;margin-inline-start:1em}slot[name='listbox']{display:none;width:100%}:host([open]) slot[name='listbox']{display:flex;position:absolute}.start{margin-inline-end:11px}.end{margin-inline-start:11px}.start,.end,.indicator,::slotted(svg){display:flex}::slotted([role='option']){flex:0 0 auto}`.withBehaviors(Zh("filled",Rd()),Zh("stealth",Dt`
  :host{background:${vl};border-color:transparent}:host(:not([disabled]):not([open]):hover){background:${yl};border-color:transparent}:host(:not([disabled]):not([open]):active){background:${xl};border-color:transparent}`),Ji(Dt`
      :host{background:${Ns.ButtonFace};color:${Ns.ButtonText}}:host(:not([disabled]):not([open]):hover){background:transparent}:host(:not([disabled]):hover){border-color:${Ns.Highlight}}:host(:${io}){forced-color-adjust:none;border-color:${Ns.Highlight};box-shadow:0 0 0 1px inset ${Ns.Highlight}}:host([open]) .listbox{background:${Ns.ButtonFace};border-color:${Ns.CanvasText}}.start,.end,.indicator,::slotted(svg){fill:${Ns.FieldText}}:host([disabled]){border-color:${Ns.GrayText};color:${Ns.GrayText};opacity:1}:host([disabled]) .start,:host([disabled]) .end,:host([disabled]) .indicator,:host([disabled]) ::slotted(svg){fill:${Ns.GrayText}}`)),Od=(t,e)=>Dt`
    ${Ed()}

    :host(:empty) .listbox{display:none}:host([disabled]) *,:host([disabled]){cursor:${"not-allowed"};user-select:none}:host(:active) .selected-value{user-select:none}.selected-value{-webkit-appearance:none;background:transparent;border:none;color:inherit;font-size:${_n};line-height:${Gn};height:calc(100% - ${jn} * 1px));margin:auto 0;width:100%}.selected-value:hover,.selected-value:${io},.selected-value:disabled,.selected-value:active{outline:none}`.withBehaviors(Zh("filled",Rd()));class Ad extends Xi{appearanceChanged(t,e){t!==e&&(this.classList.add(e),this.classList.remove(t))}connectedCallback(){super.connectedCallback(),this.appearance||(this.appearance="outline"),this.listbox&&ka.setValueFor(this.listbox,ga)}}mh([ft({mode:"fromView"})],Ad.prototype,"appearance",void 0);const Ld=Ad.compose({baseName:"combobox",baseClass:Xi,template:(t,e)=>nt`<template autocomplete="${t=>t.autocomplete}" class="${t=>t.disabled?"disabled":""} ${t=>t.position}" tabindex="${t=>t.disabled?null:"0"}" aria-disabled="${t=>t.ariaDisabled}" aria-autocomplete="${t=>t.autocomplete}" @click="${(t,e)=>t.clickHandler(e.event)}" @focusout="${(t,e)=>t.focusoutHandler(e.event)}"><div class="control" part="control">${ie(0,e)}<slot name="control"><input class="selected-value" part="selected-value" placeholder="${t=>t.placeholder}" role="${t=>t.role}" type="text" aria-activedescendant="${t=>t.open?t.ariaActiveDescendant:null}" aria-controls="${t=>t.listboxId}" aria-expanded="${t=>t.ariaExpanded}" aria-haspopup="listbox" ?disabled="${t=>t.disabled}" :value="${t=>t.value}" @input="${(t,e)=>t.inputHandler(e.event)}" @keydown="${(t,e)=>t.keydownHandler(e.event)}" @keyup="${(t,e)=>t.keyupHandler(e.event)}" ${Bt("control")} /><div class="indicator" part="indicator" aria-hidden="true"><slot name="indicator">${e.indicator||""}</slot></div></slot>${ee(0,e)}</div><div aria-disabled="${t=>t.disabled}" class="listbox" id="${t=>t.listboxId}" part="listbox" role="listbox" ?disabled="${t=>t.disabled}" ?hidden="${t=>!t.open}" ${Bt("listbox")}><slot ${Qt({filter:_i.slottedOptionFilter,flatten:!0,property:"slottedOptions"})}></slot></div></template>`,styles:Od,indicator:'\n    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg">\n      <path d="M2.15 4.65c.2-.2.5-.2.7 0L6 7.79l3.15-3.14a.5.5 0 11.7.7l-3.5 3.5a.5.5 0 01-.7 0l-3.5-3.5a.5.5 0 010-.7z"/>\n    </svg>\n  '}),zd=Od,Hd=(t,e)=>Dt`
  :host{display:flex;position:relative;flex-direction:column}`,Pd=(t,e)=>Dt`
    :host{display:grid;padding:1px 0;box-sizing:border-box;width:100%;border-bottom:calc(${jn} * 1px) solid ${_l}}:host(.header){}:host(.sticky-header){background:${ka};position:sticky;top:0}`.withBehaviors(Ji(Dt`
        :host{}`)),Md=(t,e)=>Dt`
    :host{padding:calc(${Mn} * 1px) calc(${Mn} * 3px);color:${Dl};box-sizing:border-box;font-family:${qn};font-size:${_n};line-height:${Gn};font-weight:400;border:transparent calc(${Un} * 1px) solid;overflow:hidden;outline:none;white-space:nowrap;border-radius:calc(${Bn} * 1px)}:host(.column-header){font-weight:600}:host(:${io}){border-color:${ac}}`.withBehaviors(Ji(Dt`
        :host{forced-color-adjust:none;border-color:transparent;background:${Ns.Field};color:${Ns.FieldText}}:host(:${io}){border-color:${Ns.FieldText};box-shadow:0 0 0 2px inset ${Ns.Field};color:${Ns.FieldText}}`)),Bd=Ri.compose({baseName:"data-grid-cell",template:(t,e)=>nt`<template tabindex="-1" role="${t=>{var e;return null!==(e=t.cellType)&&void 0!==e?e:"gridcell"}}" class=" ${t=>"columnheader"===t.cellType?"column-header":"rowheader"===t.cellType?"row-header":""} "><slot></slot></template>`,styles:Md}),Nd=Md,jd=Ti.compose({baseName:"data-grid-row",template:(t,e)=>nt`<template role="row" class="${t=>"default"!==t.rowType?t.rowType:""}" :defaultCellItemTemplate="${function(t){const e=t.tagFor(Ri);return nt`<${e} cell-type="${t=>t.isRowHeader?"rowheader":void 0}" grid-column="${(t,e)=>e.index+1}" :rowData="${(t,e)=>e.parent.rowData}" :columnDefinition="${t=>t}"></${e}>`}(t)}" :defaultHeaderCellItemTemplate="${function(t){const e=t.tagFor(Ri);return nt`<${e} cell-type="columnheader" grid-column="${(t,e)=>e.index+1}" :columnDefinition="${t=>t}"></${e}>`}(t)}" ${Jt({property:"cellElements",filter:Kt('[role="cell"],[role="gridcell"],[role="columnheader"],[role="rowheader"]')})}><slot ${Qt("slottedCellElements")}></slot></template>`,styles:Pd}),Ud=Pd,qd=Di.compose({baseName:"data-grid",template:(t,e)=>{const i=function(t){const e=t.tagFor(Ti);return nt`<${e} :rowData="${t=>t}" :cellItemTemplate="${(t,e)=>e.parent.cellItemTemplate}" :headerCellItemTemplate="${(t,e)=>e.parent.headerCellItemTemplate}"></${e}>`}(t),o=t.tagFor(Ti);return nt`<template role="grid" tabindex="0" :rowElementTag="${()=>o}" :defaultRowItemTemplate="${i}" ${Jt({property:"rowElements",filter:Kt("[role=row]")})}><slot></slot></template>`},styles:Hd}),_d=Hd,Gd={toView(t){var e;return null==t?null:null===(e=t)||void 0===e?void 0:e.toColorString()},fromView(t){if(null==t)return null;const e=rn(t);return e?ln.create(e.r,e.g,e.b):null}},Wd=Dt`
  :host{background-color:${ka};color:${Dl}}`.withBehaviors(Ji(Dt`
      :host{background-color:${Ns.Canvas};box-shadow:0 0 0 1px ${Ns.CanvasText};color:${Ns.CanvasText}}`));function Kd(t){return(e,i)=>{e[i+"Changed"]=function(e,i){null!=i?t.setValueFor(this,i):t.deleteValueFor(this)}}}class Xd extends je{constructor(){super(),this.noPaint=!1;const t={handleChange:this.noPaintChanged.bind(this)};C.getNotifier(this).subscribe(t,"fillColor"),C.getNotifier(this).subscribe(t,"baseLayerLuminance")}connectedCallback(){super.connectedCallback(),this.noPaintChanged()}noPaintChanged(){this.noPaint||void 0===this.fillColor&&!this.baseLayerLuminance?this.$fastController.removeStyles(Wd):this.$fastController.addStyles(Wd)}}mh([ft({attribute:"no-paint",mode:"boolean"})],Xd.prototype,"noPaint",void 0),mh([ft({attribute:"fill-color",converter:Gd,mode:"fromView"}),Kd(ka)],Xd.prototype,"fillColor",void 0),mh([ft({attribute:"accent-base-color",converter:Gd,mode:"fromView"}),Kd(ca)],Xd.prototype,"accentBaseColor",void 0),mh([ft({attribute:"neutral-base-color",converter:Gd,mode:"fromView"}),Kd(aa)],Xd.prototype,"neutralBaseColor",void 0),mh([ft({converter:pt}),Kd(Pn)],Xd.prototype,"density",void 0),mh([ft({attribute:"design-unit",converter:pt}),Kd(Mn)],Xd.prototype,"designUnit",void 0),mh([ft({attribute:"direction"}),Kd(An)],Xd.prototype,"direction",void 0),mh([ft({attribute:"base-height-multiplier",converter:pt}),Kd(zn)],Xd.prototype,"baseHeightMultiplier",void 0),mh([ft({attribute:"base-horizontal-spacing-multiplier",converter:pt}),Kd(Hn)],Xd.prototype,"baseHorizontalSpacingMultiplier",void 0),mh([ft({attribute:"control-corner-radius",converter:pt}),Kd(Bn)],Xd.prototype,"controlCornerRadius",void 0),mh([ft({attribute:"layer-corner-radius",converter:pt}),Kd(Nn)],Xd.prototype,"layerCornerRadius",void 0),mh([ft({attribute:"stroke-width",converter:pt}),Kd(jn)],Xd.prototype,"strokeWidth",void 0),mh([ft({attribute:"focus-stroke-width",converter:pt}),Kd(Un)],Xd.prototype,"focusStrokeWidth",void 0),mh([ft({attribute:"disabled-opacity",converter:pt}),Kd(Ln)],Xd.prototype,"disabledOpacity",void 0),mh([ft({attribute:"type-ramp-minus-2-font-size"}),Kd(Xn)],Xd.prototype,"typeRampMinus2FontSize",void 0),mh([ft({attribute:"type-ramp-minus-2-line-height"}),Kd(Yn)],Xd.prototype,"typeRampMinus2LineHeight",void 0),mh([ft({attribute:"type-ramp-minus-1-font-size"}),Kd(Wn)],Xd.prototype,"typeRampMinus1FontSize",void 0),mh([ft({attribute:"type-ramp-minus-1-line-height"}),Kd(Kn)],Xd.prototype,"typeRampMinus1LineHeight",void 0),mh([ft({attribute:"type-ramp-base-font-size"}),Kd(_n)],Xd.prototype,"typeRampBaseFontSize",void 0),mh([ft({attribute:"type-ramp-base-line-height"}),Kd(Gn)],Xd.prototype,"typeRampBaseLineHeight",void 0),mh([ft({attribute:"type-ramp-plus-1-font-size"}),Kd(Qn)],Xd.prototype,"typeRampPlus1FontSize",void 0),mh([ft({attribute:"type-ramp-plus-1-line-height"}),Kd(Zn)],Xd.prototype,"typeRampPlus1LineHeight",void 0),mh([ft({attribute:"type-ramp-plus-2-font-size"}),Kd(Jn)],Xd.prototype,"typeRampPlus2FontSize",void 0),mh([ft({attribute:"type-ramp-plus-2-line-height"}),Kd(tr)],Xd.prototype,"typeRampPlus2LineHeight",void 0),mh([ft({attribute:"type-ramp-plus-3-font-size"}),Kd(er)],Xd.prototype,"typeRampPlus3FontSize",void 0),mh([ft({attribute:"type-ramp-plus-3-line-height"}),Kd(ir)],Xd.prototype,"typeRampPlus3LineHeight",void 0),mh([ft({attribute:"type-ramp-plus-4-font-size"}),Kd(or)],Xd.prototype,"typeRampPlus4FontSize",void 0),mh([ft({attribute:"type-ramp-plus-4-line-height"}),Kd(sr)],Xd.prototype,"typeRampPlus4LineHeight",void 0),mh([ft({attribute:"type-ramp-plus-5-font-size"}),Kd(nr)],Xd.prototype,"typeRampPlus5FontSize",void 0),mh([ft({attribute:"type-ramp-plus-5-line-height"}),Kd(rr)],Xd.prototype,"typeRampPlus5LineHeight",void 0),mh([ft({attribute:"type-ramp-plus-6-font-size"}),Kd(ar)],Xd.prototype,"typeRampPlus6FontSize",void 0),mh([ft({attribute:"type-ramp-plus-6-line-height"}),Kd(lr)],Xd.prototype,"typeRampPlus6LineHeight",void 0),mh([ft({attribute:"accent-fill-rest-delta",converter:pt}),Kd(hr)],Xd.prototype,"accentFillRestDelta",void 0),mh([ft({attribute:"accent-fill-hover-delta",converter:pt}),Kd(dr)],Xd.prototype,"accentFillHoverDelta",void 0),mh([ft({attribute:"accent-fill-active-delta",converter:pt}),Kd(ur)],Xd.prototype,"accentFillActiveDelta",void 0),mh([ft({attribute:"accent-fill-focus-delta",converter:pt}),Kd(pr)],Xd.prototype,"accentFillFocusDelta",void 0),mh([ft({attribute:"accent-foreground-rest-delta",converter:pt}),Kd(gr)],Xd.prototype,"accentForegroundRestDelta",void 0),mh([ft({attribute:"accent-foreground-hover-delta",converter:pt}),Kd(fr)],Xd.prototype,"accentForegroundHoverDelta",void 0),mh([ft({attribute:"accent-foreground-active-delta",converter:pt}),Kd(mr)],Xd.prototype,"accentForegroundActiveDelta",void 0),mh([ft({attribute:"accent-foreground-focus-delta",converter:pt}),Kd(br)],Xd.prototype,"accentForegroundFocusDelta",void 0),mh([ft({attribute:"neutral-fill-rest-delta",converter:pt}),Kd(vr)],Xd.prototype,"neutralFillRestDelta",void 0),mh([ft({attribute:"neutral-fill-hover-delta",converter:pt}),Kd(yr)],Xd.prototype,"neutralFillHoverDelta",void 0),mh([ft({attribute:"neutral-fill-active-delta",converter:pt}),Kd(xr)],Xd.prototype,"neutralFillActiveDelta",void 0),mh([ft({attribute:"neutral-fill-focus-delta",converter:pt}),Kd($r)],Xd.prototype,"neutralFillFocusDelta",void 0),mh([ft({attribute:"neutral-fill-input-rest-delta",converter:pt}),Kd(wr)],Xd.prototype,"neutralFillInputRestDelta",void 0),mh([ft({attribute:"neutral-fill-input-hover-delta",converter:pt}),Kd(kr)],Xd.prototype,"neutralFillInputHoverDelta",void 0),mh([ft({attribute:"neutral-fill-input-active-delta",converter:pt}),Kd(Cr)],Xd.prototype,"neutralFillInputActiveDelta",void 0),mh([ft({attribute:"neutral-fill-input-focus-delta",converter:pt}),Kd(Fr)],Xd.prototype,"neutralFillInputFocusDelta",void 0),mh([ft({attribute:"neutral-fill-layer-rest-delta",converter:pt}),Kd(Sr)],Xd.prototype,"neutralFillLayerRestDelta",void 0),mh([ft({attribute:"neutral-fill-stealth-rest-delta",converter:pt}),Kd(Pr)],Xd.prototype,"neutralFillStealthRestDelta",void 0),mh([ft({attribute:"neutral-fill-stealth-hover-delta",converter:pt}),Kd(Mr)],Xd.prototype,"neutralFillStealthHoverDelta",void 0),mh([ft({attribute:"neutral-fill-stealth-active-delta",converter:pt}),Kd(Br)],Xd.prototype,"neutralFillStealthActiveDelta",void 0),mh([ft({attribute:"neutral-fill-stealth-focus-delta",converter:pt}),Kd(Nr)],Xd.prototype,"neutralFillStealthFocusDelta",void 0),mh([ft({attribute:"neutral-fill-strong-hover-delta",converter:pt}),Kd(Ur)],Xd.prototype,"neutralFillStrongHoverDelta",void 0),mh([ft({attribute:"neutral-fill-strong-active-delta",converter:pt}),Kd(qr)],Xd.prototype,"neutralFillStrongActiveDelta",void 0),mh([ft({attribute:"neutral-fill-strong-focus-delta",converter:pt}),Kd(_r)],Xd.prototype,"neutralFillStrongFocusDelta",void 0),mh([ft({attribute:"base-layer-luminance",converter:pt}),Kd(cr)],Xd.prototype,"baseLayerLuminance",void 0),mh([ft({attribute:"neutral-stroke-divider-rest-delta",converter:pt}),Kd(ta)],Xd.prototype,"neutralStrokeDividerRestDelta",void 0),mh([ft({attribute:"neutral-stroke-rest-delta",converter:pt}),Kd(Gr)],Xd.prototype,"neutralStrokeRestDelta",void 0),mh([ft({attribute:"neutral-stroke-hover-delta",converter:pt}),Kd(Wr)],Xd.prototype,"neutralStrokeHoverDelta",void 0),mh([ft({attribute:"neutral-stroke-active-delta",converter:pt}),Kd(Kr)],Xd.prototype,"neutralStrokeActiveDelta",void 0),mh([ft({attribute:"neutral-stroke-focus-delta",converter:pt}),Kd(Xr)],Xd.prototype,"neutralStrokeFocusDelta",void 0);const Yd=Xd.compose({baseName:"design-system-provider",template:nt`<slot></slot>`,styles:Dt`
    ${eo("block")}
  `}),Qd=(t,e)=>Dt`
  ...
  ${eo("block")} :host{--scroll-align:center;--scroll-item-spacing:4px;contain:layout;position:relative}.scroll-view{overflow-x:auto;scrollbar-width:none}::-webkit-scrollbar{display:none}.content-container{align-items:var(--scroll-align);display:inline-flex;flex-wrap:nowrap;position:relative}.content-container ::slotted(*){margin-right:var(--scroll-item-spacing)}.content-container ::slotted(*:last-child){margin-right:0}`;class hu extends ls{connectedCallback(){super.connectedCallback(),"mobile"!==this.view&&this.$fastController.addStyles(lu)}}const du=hu.compose({baseName:"horizontal-scroll",baseClass:ls,template:(t,e)=>{var i,o;return nt`<template class="horizontal-scroll" @keyup="${(t,e)=>t.keyupHandler(e.event)}">${ie(0,e)}<div class="scroll-area" part="scroll-area"><div class="scroll-view" part="scroll-view" @scroll="${t=>t.scrolled()}" ${Bt("scrollContainer")}><div class="content-container" part="content-container" ${Bt("content")}><slot ${Qt({property:"scrollItems",filter:Kt()})}></slot></div></div>${Nt(t=>"mobile"!==t.view,nt`<div class="scroll scroll-prev" part="scroll-prev" ${Bt("previousFlipperContainer")}><div class="scroll-action" part="scroll-action-previous"><slot name="previous-flipper">${e.previousFlipper instanceof Function?e.previousFlipper(t,e):null!==(i=e.previousFlipper)&&void 0!==i?i:""}</slot></div></div><div class="scroll scroll-next" part="scroll-next" ${Bt("nextFlipperContainer")}><div class="scroll-action" part="scroll-action-next"><slot name="next-flipper">${e.nextFlipper instanceof Function?e.nextFlipper(t,e):null!==(o=e.nextFlipper)&&void 0!==o?o:""}</slot></div></div>`)}</div>${ee(0,e)}</template>`},styles:cu,nextFlipper:nt`<fluent-flipper @click="${t=>t.scrollToNext()}" aria-hidden="${t=>t.flippersHiddenFromAT}"></fluent-flipper>`,previousFlipper:nt`<fluent-flipper @click="${t=>t.scrollToPrevious()}" direction="previous" aria-hidden="${t=>t.flippersHiddenFromAT}"></fluent-flipper>`}),uu=cu,pu=(t,e)=>Dt`
    ...
    .root{display:flex;flex-direction:row}.control{-webkit-appearance:none;color:inherit;background:transparent;border:0;height:calc(100% - 4px);margin-top:auto;margin-bottom:auto;padding:0 calc(${Mn} * 2px + 1px);font-family:inherit;font-size:inherit;line-height:inherit}.start,.end{margin:auto;fill:currentcolor}.start{display:flex;margin-inline-start:11px}.end{display:flex;margin-inline-end:11px}.controls{opacity:0;position:relative;top:-1px;z-index:3}:host(:hover:not([disabled])) .controls,:host(:focus-within:not([disabled])) .controls{opacity:1}.step-up,.step-down{display:flex;padding:0 8px;cursor:pointer}.step-up{padding-top:3px}`.withBehaviors(Zh("filled",Dt`
    ${Xh(0,0,".root")}
  `.withBehaviors(Ji(Dt`
        ${Qh(0,0,".root")}
      `))),Ji(Dt`
  ...
  ${eo("block")} :host{box-sizing:border-box;font-family:${qn};font-size:${Wn};font-weight:400;line-height:${Kn};padding:0 calc((6 + (${Mn} * 2 * ${Pn})) * 1px)}`,hp=Cs.compose({baseName:"tab-panel",template:(t,e)=>nt`<template slot="tabpanel" role="tabpanel"><slot></slot></template>`,styles:cp}),dp=cp,up=Ds.compose({baseName:"tabs",template:(t,e)=>nt`<template class="${t=>t.orientation}">${ie(0,e)}<div class="tablist" part="tablist" role="tablist"><slot class="tab" name="tab" part="tab" ${Qt("tabs")}></slot>${Nt(t=>t.showActiveIndicator,nt`<div ${Bt("activeIndicatorRef")} class="activeIndicator" part="activeIndicator"></div>`)}</div>${ee(0,e)}<div class="tabpanel"><slot name="tabpanel" part="tabpanel" ${Qt("tabpanels")}></slot></div></template>`,styles:np}),pp=np,gp=(t,e)=>Dt`
    ${eo("inline-flex")}
    ...
    :host{flex-direction:column;vertical-align:bottom}.control{height:calc((${ah} * 2) * 1px);padding:calc(${Mn} * 1.5px) calc(${Mn} * 2px + 1px)}:host .control{resize:none}:host(.resize-both) .control{resize:both}:host(.resize-horizontal) .control{resize:horizontal}:host(.resize-vertical) .control{resize:vertical}`.withBehaviors(Zh("filled",Dt`
    ${Xh(0,0,".control")}
  `.withBehaviors(Ji(Dt`
        ${Qh(0,0,".control")}
      `))),Ji(Dt`
        ${Yh(0,0,".control")}
      `));class fp extends Rs{appearanceChanged(t,e){t!==e&&(this.classList.add(e),this.classList.remove(t))}connectedCallback(){super.connectedCallback(),this.appearance||(this.appearance="outline")}}mh([ft],fp.prototype,"appearance",void 0);const mp=fp.compose({baseName:"text-area",baseClass:Rs,template:(t,e)=>nt`<template class=" ${t=>t.readOnly?"readonly":""} ${t=>t.resize!==Ts.none?"resize-"+t.resize:""}"><label part="label" for="control" class="${t=>t.defaultSlottedNodes&&t.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Qt("defaultSlottedNodes")}></slot></label><textarea part="control" class="control" id="control" ?autofocus="${t=>t.autofocus}" cols="${t=>t.cols}" ?disabled="${t=>t.disabled}" form="${t=>t.form}" list="${t=>t.list}" maxlength="${t=>t.maxlength}" minlength="${t=>t.minlength}" name="${t=>t.name}" placeholder="${t=>t.placeholder}" ?readonly="${t=>t.readOnly}" ?required="${t=>t.required}" rows="${t=>t.rows}" ?spellcheck="${t=>t.spellcheck}" :value="${t=>t.value}" aria-atomic="${t=>t.ariaAtomic}" aria-busy="${t=>t.ariaBusy}" aria-controls="${t=>t.ariaControls}" aria-current="${t=>t.ariaCurrent}" aria-describedby="${t=>t.ariaDescribedby}" aria-details="${t=>t.ariaDetails}" aria-disabled="${t=>t.ariaDisabled}" aria-errormessage="${t=>t.ariaErrormessage}" aria-flowto="${t=>t.ariaFlowto}" aria-haspopup="${t=>t.ariaHaspopup}" aria-hidden="${t=>t.ariaHidden}" aria-invalid="${t=>t.ariaInvalid}" aria-keyshortcuts="${t=>t.ariaKeyshortcuts}" aria-label="${t=>t.ariaLabel}" aria-labelledby="${t=>t.ariaLabelledby}" aria-live="${t=>t.ariaLive}" aria-owns="${t=>t.ariaOwns}" aria-relevant="${t=>t.ariaRelevant}" aria-roledescription="${t=>t.ariaRoledescription}" @input="${(t,e)=>t.handleTextInput()}" @change="${t=>t.handleChange()}" ${Bt("control")}></textarea></template>`,styles:gp,shadowOptions:{delegatesFocus:!0}}),bp=gp,vp=(t,e)=>Dt`
    ${eo("inline-block")}
    ...
    .root{display:flex;flex-direction:row}.control{-webkit-appearance:none;color:inherit;background:transparent;border:0;height:calc(100% - 4px);margin-top:auto;margin-bottom:auto;padding:0 calc(${Mn} * 2px + 1px);font-family:inherit;font-size:inherit;line-height:inherit}.start,.end{display:flex;margin:auto}.start{display:flex;margin-inline-start:11px}.end{display:flex;margin-inline-end:11px}`.withBehaviors(Zh("filled",Dt`
    ${Xh(0,0,".root")}
  `.withBehaviors(Ji(Dt`
        ${Qh(0,0,".root")}
      `))),Ji(Dt`
        ${Yh(0,0,".root")}
      `));class yp extends Zo{appearanceChanged(t,e){t!==e&&(this.classList.add(e),this.classList.remove(t))}connectedCallback(){super.connectedCallback(),this.appearance||(this.appearance="outline")}}mh([ft],yp.prototype,"appearance",void 0);const xp=yp.compose({baseName:"text-field",baseClass:Zo,template:(t,e)=>nt`<template class=" ${t=>t.readOnly?"readonly":""} "><label part="label" for="control" class="${t=>t.defaultSlottedNodes&&t.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Qt({property:"defaultSlottedNodes",filter:oo})}></slot></label><div class="root" part="root">${ie(0,e)}<input class="control" part="control" id="control" @input="${t=>t.handleTextInput()}" @change="${t=>t.handleChange()}" ?autofocus="${t=>t.autofocus}" ?disabled="${t=>t.disabled}" list="${t=>t.list}" maxlength="${t=>t.maxlength}" minlength="${t=>t.minlength}" pattern="${t=>t.pattern}" placeholder="${t=>t.placeholder}" ?readonly="${t=>t.readOnly}" ?required="${t=>t.required}" size="${t=>t.size}" ?spellcheck="${t=>t.spellcheck}" :value="${t=>t.value}" type="${t=>t.type}" aria-atomic="${t=>t.ariaAtomic}" aria-busy="${t=>t.ariaBusy}" aria-controls="${t=>t.ariaControls}" aria-current="${t=>t.ariaCurrent}" aria-describedby="${t=>t.ariaDescribedby}" aria-details="${t=>t.ariaDetails}" aria-disabled="${t=>t.ariaDisabled}" aria-errormessage="${t=>t.ariaErrormessage}" aria-flowto="${t=>t.ariaFlowto}" aria-haspopup="${t=>t.ariaHaspopup}" aria-hidden="${t=>t.ariaHidden}" aria-invalid="${t=>t.ariaInvalid}" aria-keyshortcuts="${t=>t.ariaKeyshortcuts}" aria-label="${t=>t.ariaLabel}" aria-labelledby="${t=>t.ariaLabelledby}" aria-live="${t=>t.ariaLive}" aria-owns="${t=>t.ariaOwns}" aria-relevant="${t=>t.ariaRelevant}" aria-roledescription="${t=>t.ariaRoledescription}" ${Bt("control")} />${ee(0,e)}</div></template>`,styles:vp,shadowOptions:{delegatesFocus:!0}}),$p=vp;class wp extends Os{}const kp=wp.compose({baseName:"toolbar",baseClass:Os,template:(t,e)=>nt`<template aria-label="${t=>t.ariaLabel}" aria-labelledby="${t=>t.ariaLabelledby}" aria-orientation="${t=>t.orientation}" orientation="${t=>t.orientation}" role="toolbar" @click="${(t,e)=>t.clickHandler(e.event)}" @focusin="${(t,e)=>t.focusinHandler(e.event)}" @keydown="${(t,e)=>t.keydownHandler(e.event)}"><slot name="label"></slot><div class="positioning-region" part="positioning-region">${ie(0,e)}<slot ${Qt({filter:Kt(),property:"slottedItems"})}></slot>${ee(0,e)}</div></template>`,styles:(t,e)=>Dt`
    ${eo("inline-flex")} :host{--toolbar-item-gap:calc(${Mn} * 1px);background:${ka};fill:currentcolor;padding:var(--toolbar-item-gap);box-sizing:border-box;align-items:center}:host(${io}){outline:calc(${jn} * 1px) solid ${Pl}}.positioning-region{align-items:center;display:inline-flex;flex-flow:row wrap;justify-content:flex-start;flex-grow:1}:host([orientation='vertical']) .positioning-region{flex-direction:column;align-items:start}::slotted(:not([slot])){flex:0 0 auto;margin:0 var(--toolbar-item-gap)}:host([orientation='vertical']) ::slotted(:not([slot])){margin:var(--toolbar-item-gap) 0}:host([orientation='vertical']){display:inline-flex;flex-direction:column}.start,.end{display:flex;align-items:center}.end{margin-inline-start:auto}.start__hidden,.end__hidden{display:none}::slotted(svg){${""}
      width:16px;height:16px}`.withBehaviors(Ji(Dt`
        :host(:${io}){box-shadow:0 0 0 calc(${Un} * 1px) ${Ns.Highlight};color:${Ns.ButtonText};forced-color-adjust:none}`))});class Cp extends zs{connectedCallback(){super.connectedCallback(),ka.setValueFor(this,ga)}}const Fp=Cp.compose({baseName:"tooltip",baseClass:zs,template:(t,e)=>nt` ${Nt(t=>t.tooltipVisible,nt`<${t.tagFor(hi)} fixed-placement="true" auto-update-mode="${t=>t.autoUpdateMode}" vertical-positioning-mode="${t=>t.verticalPositioningMode}" vertical-default-position="${t=>t.verticalDefaultPosition}" vertical-inset="${t=>t.verticalInset}" vertical-scaling="${t=>t.verticalScaling}" horizontal-positioning-mode="${t=>t.horizontalPositioningMode}" horizontal-default-position="${t=>t.horizontalDefaultPosition}" horizontal-scaling="${t=>t.horizontalScaling}" horizontal-inset="${t=>t.horizontalInset}" vertical-viewport-lock="${t=>t.horizontalViewportLock}" horizontal-viewport-lock="${t=>t.verticalViewportLock}" dir="${t=>t.currentDirection}" ${Bt("region")}><div class="tooltip" part="tooltip" role="tooltip"><slot></slot></div></${t.tagFor(hi)}>`)} `,styles:(t,e)=>Dt`
    :host{position:relative;contain:layout;overflow:visible;height:0;width:0;z-index:10000}.tooltip{box-sizing:border-box;border-radius:calc(${Bn} * 1px);border:calc(${jn} * 1px) solid ${Zl};background:${ka};color:${Dl};padding:4px 12px;height:fit-content;width:fit-content;font-family:${qn};font-size:${_n};line-height:${Gn};white-space:nowrap;box-shadow:${Eh}}fluent-anchored-region{display:flex;justify-content:center;align-items:center;overflow:visible;flex-direction:row}fluent-anchored-region.right,fluent-anchored-region.left{flex-direction:column}fluent-anchored-region.top .tooltip::after,fluent-anchored-region.bottom .tooltip::after,fluent-anchored-region.left .tooltip::after,fluent-anchored-region.right .tooltip::after{content:'';width:12px;height:12px;background:${ka};border-top:calc(${jn} * 1px) solid ${Zl};border-left:calc(${jn} * 1px) solid ${Zl};position:absolute}fluent-anchored-region.top .tooltip::after{transform:translateX(-50%) rotate(225deg);bottom:5px;left:50%}fluent-anchored-region.top .tooltip{margin-bottom:12px}fluent-anchored-region.bottom .tooltip::after{transform:translateX(-50%) rotate(45deg);top:5px;left:50%}fluent-anchored-region.bottom .tooltip{margin-top:12px}fluent-anchored-region.left .tooltip::after{transform:translateY(-50%) rotate(135deg);top:50%;right:5px}fluent-anchored-region.left .tooltip{margin-right:12px}fluent-anchored-region.right .tooltip::after{transform:translateY(-50%) rotate(-45deg);top:50%;left:5px}fluent-anchored-region.right .tooltip{margin-left:12px}`.withBehaviors(Ji(Dt`
        :host([disabled]){opacity:1}fluent-anchored-region.top .tooltip::after,fluent-anchored-region.bottom .tooltip::after,fluent-anchored-region.left .tooltip::after,fluent-anchored-region.right .tooltip::after{content:'';width:unset;height:unset}`))}),Ip=(t,e)=>Dt`
  :host([hidden]){display:none}${eo("flex")} :host{flex-direction:column;align-items:stretch;min-width:fit-content;font-size:0}:host:focus-visible{outline:none}`,Tp=Ms.compose({baseName:"tree-view",template:(t,e)=>nt`<template role="tree" ${Bt("treeView")} @keydown="${(t,e)=>t.handleKeyDown(e.event)}" @focusout="${(t,e)=>t.handleBlur(e.event)}" @focusin="${(t,e)=>t.handleFocus(e.event)}"><slot ${Qt("slottedTreeItems")}></slot></template>`,styles:Ip}),Dp=Ip,Vp=Dt`
  .expand-collapse-button svg{transform:rotate(0deg)}:host(.nested) .expand-collapse-button{left:var(--expand-collapse-button-nested-width,calc(${ah} * -1px))}:host([selected])::after{left:calc(${Un} * 1px)}:host([expanded]) > .positioning-region .expand-collapse-button svg{transform:rotate(90deg)}`,Sp=Dt`
  .expand-collapse-button svg{transform:rotate(180deg)}:host(.nested) .expand-collapse-button{right:var(--expand-collapse-button-nested-width,calc(${ah} * -1px))}:host([selected])::after{right:calc(${Un} * 1px)}:host([expanded]) > .positioning-region .expand-collapse-button svg{transform:rotate(90deg)}`,Rp=St`((${zn} / 2) * ${Mn}) + ((${Mn} * ${Pn}) / 2)`,Ep=$o.create("tree-item-expand-collapse-hover").withDefault(t=>{const e=bl.getValueFor(t);return e.evaluate(t,e.evaluate(t).hover).hover}),Op=$o.create("tree-item-expand-collapse-selected-hover").withDefault(t=>{const e=ul.getValueFor(t);return bl.getValueFor(t).evaluate(t,e.evaluate(t).rest).hover}),Ap=(t,e)=>Dt`
    ${eo("block")} :host{contain:content;position:relative;outline:none;color:${Dl};fill:currentcolor;cursor:pointer;font-family:${qn};--expand-collapse-button-size:calc(${ah} * 1px);--tree-item-nested-width:0}:host(:focus) > .positioning-region{outline:none}:host(:focus) .content-region{outline:none}.positioning-region{display:flex;position:relative;box-sizing:border-box;background:${vl};border:calc(${jn} * 1px) solid transparent;border-radius:calc(${Bn} * 1px);height:calc((${ah} + 1) * 1px)}:host(:${io}) .positioning-region{border-color:${ac};box-shadow:0 0 0 calc((${Un} - ${jn}) * 1px) ${ac} inset}.positioning-region::before{content:'';display:block;width:var(--tree-item-nested-width);flex-shrink:0}:host(:not([disabled])) .positioning-region:hover{background:${yl}}:host(:not([disabled])) .positioning-region:active{background:${xl}}.content-region{display:inline-flex;align-items:center;white-space:nowrap;width:100%;height:calc(${ah} * 1px);margin-inline-start:calc(${Mn} * 2px + 8px);font-size:${_n};line-height:${Gn};font-weight:400}.items{display:none;${""} font-size:calc(1em + (${Mn} + 16) * 1px)}.expand-collapse-button{background:none;border:none;border-radius:calc(${Bn} * 1px);outline:none;${""} width:calc((${Rp} + (${Mn} * 2)) * 1px);height:calc((${Rp} + (${Mn} * 2)) * 1px);padding:0;display:flex;justify-content:center;align-items:center;cursor:pointer;margin:0 6px}.expand-collapse-button svg{transition:transform 0.1s linear;pointer-events:none}.start,.end{display:flex}.start{${""} margin-inline-end:calc(${Mn} * 2px + 2px)}.end{${""} margin-inline-start:calc(${Mn} * 2px + 2px)}:host(.expanded) > .items{display:block}:host([disabled]){opacity:${Ln};cursor:${"not-allowed"}}:host(.nested) .content-region{position:relative;margin-inline-start:var(--expand-collapse-button-size)}:host(.nested) .expand-collapse-button{position:absolute}:host(.nested) .expand-collapse-button:hover{background:${Ep}}:host(:not([disabled])[selected]) .positioning-region{background:${pl}}:host(:not([disabled])[selected]) .expand-collapse-button:hover{background:${Op}}:host([selected])::after{content:'';display:block;position:absolute;top:calc((${ah} / 4) * 1px);width:3px;height:calc((${ah} / 2) * 1px);${""} background:${Ia};border-radius:calc(${Bn} * 1px)}::slotted(fluent-tree-item){--tree-item-nested-width:1em;--expand-collapse-button-nested-width:calc(${ah} * -1px)}`.withBehaviors(new bh(Vp,Sp),Ji(Dt`
        :host{color:${Ns.ButtonText}}.positioning-region{border-color:${Ns.ButtonFace};background:${Ns.ButtonFace}}:host(:not([disabled])) .positioning-region:hover,:host(:not([disabled])) .positioning-region:active,:host(:not([disabled])[selected]) .positioning-region{background:${Ns.Highlight}}:host .positioning-region:hover .content-region,:host([selected]) .positioning-region .content-region{forced-color-adjust:none;color:${Ns.HighlightText}}:host([disabled][selected]) .positioning-region .content-region{color:${Ns.GrayText}}:host([selected])::after{background:${Ns.HighlightText}}:host(:${io}) .positioning-region{forced-color-adjust:none;border-color:${Ns.ButtonText};box-shadow:0 0 0 2px inset ${Ns.ButtonFace}}:host([disabled]),:host([disabled]) .content-region,:host([disabled]) .positioning-region:hover .content-region{opacity:1;color:${Ns.GrayText}}:host(.nested) .expand-collapse-button:hover,:host(:not([disabled])[selected]) .expand-collapse-button:hover{background:${Ns.ButtonFace};fill:${Ns.ButtonText}}`)),Lp=Ps.compose({baseName:"tree-item",template:(t,e)=>nt`<template role="treeitem" slot="${t=>t.isNestedItem()?"item":void 0}" tabindex="${t=>t.focusable?0:-1}" class="${t=>t.expanded?"expanded":""} ${t=>t.selected?"selected":""} ${t=>t.nested?"nested":""} ${t=>t.disabled?"disabled":""}" aria-expanded="${t=>t.childItems&&t.childItemLength()>0?t.expanded:void 0}" aria-selected="${t=>t.selected}" aria-disabled="${t=>t.disabled}" @click="${(t,e)=>t.handleClick(e.event)}" ${Jt({property:"childItems",filter:Kt()})}><div class="positioning-region" part="positioning-region"><div class="content-region" part="content-region">${Nt(t=>t.childItems&&t.childItemLength()>0,nt`<div aria-hidden="true" class="expand-collapse-button" part="expand-collapse-button" @click="${(t,e)=>t.handleExpandCollapseButtonClick(e.event)}" ${Bt("expandCollapseButton")}><slot name="expand-collapse-glyph">${e.expandCollapseGlyph||""}</slot></div>`)} ${ie(0,e)}<slot></slot>${ee(0,e)}</div></div>${Nt(t=>t.childItems&&t.childItemLength()>0&&(t.expanded||t.renderCollapsedChildren),nt`<div role="group" class="items" part="items"><slot name="item" ${Qt("items")}></slot></div>`)}</template>`,styles:Ap,expandCollapseGlyph:'\n    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg">\n      <path d="M4.65 2.15a.5.5 0 000 .7L7.79 6 4.65 9.15a.5.5 0 10.7.7l3.5-3.5a.5.5 0 000-.7l-3.5-3.5a.5.5 0 00-.7 0z"/>\n    </svg>\n  '}),zp=Ap,Hp={fluentAccordion:gh,fluentAccordionItem:uh,fluentAnchor:id,fluentAnchoredRegion:sd,fluentBadge:ld,fluentBreadcrumb:dd,fluentBreadcrumbItem:gd,fluentButton:vd,fluentCalendar:kd,fluentCard:Id,fluentCheckbox:Vd,fluentCombobox:Ld,fluentDataGrid:qd,fluentDataGridCell:Bd,fluentDataGridRow:jd,fluentDesignSystemProvider:Yd,fluentDialog:Zd,fluentDivider:eu,fluentFlipper:su,fluentHorizontalScroll:du,fluentListbox:gu,fluentOption:bu,fluentMenu:$u,fluentMenuItem:Cu,fluentNumberField:Vu,fluentProgress:Eu,fluentProgressRing:zu,fluentRadio:Mu,fluentRadioGroup:ju,fluentSelect:_u,fluentSkeleton:Ku,fluentSlider:Qu,fluentSliderLabel:tp,fluentSwitch:op,fluentTabs:up,fluentTab:ap,fluentTabPanel:hp,fluentTextArea:mp,fluentTextField:xp,fluentToolbar:kp,fluentTooltip:Fp,fluentTreeView:Tp,fluentTreeItem:Lp,register(t,...e){if(t)for(const i in this)"register"!==i&&this[i]().register(t,...e)}};function Pp(t){return To.getOrCreate(t).withPrefix("fluent")}const Mp=Pp().register(Hp);export{Ph as AccentButtonStyles,si as Accordion,Ge as AccordionItem,td as Anchor,hi as AnchoredRegion,ad as Badge,pi as Breadcrumb,ui as BreadcrumbItem,bd as Button,Fd as Card,Ad as Combobox,Di as DataGrid,Ri as DataGridCell,Ti as DataGridRow,Xd as DesignSystemProvider,Bo as Dialog,bh as DirectionalStyleSheetBehavior,Uo as Divider,qo as Flipper,Mp as FluentDesignSystem,hu as HorizontalScroll,Mh as HypertextStyles,Bh as LightweightButtonStyles,_i as Listbox,xu as Menu,Wo as MenuItem,Tu as NumberField,vu as OptionStyles,Nh as OutlineButtonStyles,gn as PaletteRGB,Ru as Progress,Lu as ProgressRing,as as Radio,ss as RadioGroup,Bu as RadioStyles,qu as Select,ps as Skeleton,xs as Slider,ms as SliderLabel,Vn as StandardLuminance,jh as StealthButtonStyles,ln as SwatchRGB,ks as Switch,Fs as Tab,Cs as TabPanel,Ds as Tabs,fp as TextArea,yp as TextField,wp as Toolbar,Cp as Tooltip,Ps as TreeItem,Ms as TreeView,ca as accentBaseColor,Da as accentFillActive,ur as accentFillActiveDelta,Va as accentFillFocus,pr as accentFillFocusDelta,Ta as accentFillHover,dr as accentFillHoverDelta,Fa as accentFillRecipe,Ia as accentFillRest,hr as accentFillRestDelta,Pa as accentForegroundActive,mr as accentForegroundActiveDelta,jc as accentForegroundCut,Uc as accentForegroundCutLarge,Ma as accentForegroundFocus,br as accentForegroundFocusDelta,Ha as accentForegroundHover,fr as accentForegroundHoverDelta,La as accentForegroundRecipe,za as accentForegroundRest,gr as accentForegroundRestDelta,ha as accentPalette,Ua as accentStrokeControlActive,qa as accentStrokeControlFocus,ja as accentStrokeControlHover,Ba as accentStrokeControlRecipe,Na as accentStrokeControlRest,ph as accordionItemStyles,fh as accordionStyles,Hp as allComponents,yh as ambientShadow,ed as anchorStyles,nd as anchoredRegionStyles,cd as badgeStyles,Hh as baseButtonStyles,zn as baseHeightMultiplier,Hn as baseHorizontalSpacingMultiplier,cr as baseLayerLuminance,qn as bodyFont,fd as breadcrumbItemStyles,ud as breadcrumbStyles,yd as buttonStyles,Td as cardStyles,Sd as checkboxStyles,zd as comboboxStyles,Bn as controlCornerRadius,Cc as cornerRadius,Nd as dataGridCellStyles,Ud as dataGridRowStyles,_d as dataGridStyles,Pn as density,Mn as designUnit,Jd as dialogStyles,An as direction,xh as directionalShadow,Ln as disabledOpacity,iu as dividerStyles,Fc as elevatedCornerRadius,$h as elevation,Vh as elevationShadowCardActive,Fh as elevationShadowCardActiveSize,Sh as elevationShadowCardFocus,Ih as elevationShadowCardFocusSize,Dh as elevationShadowCardHover,Ch as elevationShadowCardHoverSize,Th as elevationShadowCardRest,kh as elevationShadowCardRestSize,zh as elevationShadowDialog,Lh as elevationShadowDialogSize,Ah as elevationShadowFlyout,Oh as elevationShadowFlyoutSize,wh as elevationShadowRecipe,Eh as elevationShadowTooltip,Rh as elevationShadowTooltipSize,ka as fillColor,nu as flipperStyles,gh as fluentAccordion,uh as fluentAccordionItem,id as fluentAnchor,sd as fluentAnchoredRegion,ld as fluentBadge,dd as fluentBreadcrumb,gd as fluentBreadcrumbItem,vd as fluentButton,kd as fluentCalendar,Id as fluentCard,Vd as fluentCheckbox,Ld as fluentCombobox,qd as fluentDataGrid,Bd as fluentDataGridCell,jd as fluentDataGridRow,Yd as fluentDesignSystemProvider,Zd as fluentDialog,eu as fluentDivider,su as fluentFlipper,du as fluentHorizontalScroll,gu as fluentListbox,$u as fluentMenu,Cu as fluentMenuItem,Vu as fluentNumberField,bu as fluentOption,Eu as fluentProgress,zu as fluentProgressRing,Mu as fluentRadio,ju as fluentRadioGroup,_u as fluentSelect,Ku as fluentSkeleton,Qu as fluentSlider,tp as fluentSliderLabel,op as fluentSwitch,ap as fluentTab,hp as fluentTabPanel,up as fluentTabs,mp as fluentTextArea,xp as fluentTextField,kp as fluentToolbar,Fp as fluentTooltip,Lp as fluentTreeItem,Tp as fluentTreeView,Tc as focusOutlineWidth,cc as focusStrokeInner,lc as focusStrokeInnerRecipe,ac as focusStrokeOuter,rc as focusStrokeOuterRecipe,Un as focusStrokeWidth,Oa as foregroundOnAccentActive,pc as foregroundOnAccentActiveLarge,Aa as foregroundOnAccentFocus,gc as foregroundOnAccentFocusLarge,Ea as foregroundOnAccentHover,uc as foregroundOnAccentHoverLarge,hc as foregroundOnAccentLargeRecipe,Sa as foregroundOnAccentRecipe,Ra as foregroundOnAccentRest,dc as foregroundOnAccentRestLarge,ah as heightNumber,uu as horizontalScrollStyles,Qh as inputFilledForcedColorStyles,Xh as inputFilledStyles,Yh as inputForcedColorStyles,Kh as inputStateStyles,Wh as inputStyles,dn as isDark,Nn as layerCornerRadius,fu as listboxStyles,Fu as menuItemStyles,wu as menuStyles,aa as neutralBaseColor,Kc as neutralContrastFillActive,Sc as neutralContrastFillActiveDelta,Xc as neutralContrastFillFocus,Rc as neutralContrastFillFocusDelta,Wc as neutralContrastFillHover,Vc as neutralContrastFillHoverDelta,Gc as neutralContrastFillRest,Dc as neutralContrastFillRestDelta,qc as neutralDivider,Hc as neutralDividerRestDelta,Ka as neutralFillActive,xr as neutralFillActiveDelta,_c as neutralFillCard,Ec as neutralFillCardDelta,Xa as neutralFillFocus,$r as neutralFillFocusDelta,Wa as neutralFillHover,yr as neutralFillHoverDelta,Ja as neutralFillInputActive,Cr as neutralFillInputActiveDelta,sl as neutralFillInputAltActive,Dr as neutralFillInputAltActiveDelta,nl as neutralFillInputAltFocus,Vr as neutralFillInputAltFocusDelta,ol as neutralFillInputAltHover,Tr as neutralFillInputAltHoverDelta,el as neutralFillInputAltRecipe,il as neutralFillInputAltRest,Ir as neutralFillInputAltRestDelta,tl as neutralFillInputFocus,Fr as neutralFillInputFocusDelta,Za as neutralFillInputHover,kr as neutralFillInputHoverDelta,Ya as neutralFillInputRecipe,Qa as neutralFillInputRest,wr as neutralFillInputRestDelta,wc as neutralFillInverseActive,bc as neutralFillInverseActiveDelta,kc as neutralFillInverseFocus,vc as neutralFillInverseFocusDelta,$c as neutralFillInverseHover,mc as neutralFillInverseHoverDelta,yc as neutralFillInverseRecipe,xc as neutralFillInverseRest,fc as neutralFillInverseRestDelta,cl as neutralFillLayerActive,Er as neutralFillLayerActiveDelta,hl as neutralFillLayerAltRecipe,dl as neutralFillLayerAltRest,Or as neutralFillLayerAltRestDelta,ll as neutralFillLayerHover,Rr as neutralFillLayerHoverDelta,rl as neutralFillLayerRecipe,al as neutralFillLayerRest,Sr as neutralFillLayerRestDelta,_a as neutralFillRecipe,Ga as neutralFillRest,vr as neutralFillRestDelta,fl as neutralFillSecondaryActive,zr as neutralFillSecondaryActiveDelta,ml as neutralFillSecondaryFocus,Hr as neutralFillSecondaryFocusDelta,gl as neutralFillSecondaryHover,Lr as neutralFillSecondaryHoverDelta,ul as neutralFillSecondaryRecipe,pl as neutralFillSecondaryRest,Ar as neutralFillSecondaryRestDelta,xl as neutralFillStealthActive,Br as neutralFillStealthActiveDelta,$l as neutralFillStealthFocus,Nr as neutralFillStealthFocusDelta,yl as neutralFillStealthHover,Mr as neutralFillStealthHoverDelta,bl as neutralFillStealthRecipe,vl as neutralFillStealthRest,Pr as neutralFillStealthRestDelta,Fl as neutralFillStrongActive,qr as neutralFillStrongActiveDelta,Il as neutralFillStrongFocus,_r as neutralFillStrongFocusDelta,Cl as neutralFillStrongHover,Ur as neutralFillStrongHoverDelta,wl as neutralFillStrongRecipe,kl as neutralFillStrongRest,jr as neutralFillStrongRestDelta,Zc as neutralFillToggleActive,Lc as neutralFillToggleActiveDelta,Jc as neutralFillToggleFocus,zc as neutralFillToggleFocusDelta,Qc as neutralFillToggleHover,Ac as neutralFillToggleHoverDelta,Yc as neutralFillToggleRest,Oc as neutralFillToggleRestDelta,th as neutralFocus,eh as neutralFocusInnerAccent,Sl as neutralForegroundActive,Rl as neutralForegroundFocus,Ol as neutralForegroundHint,El as neutralForegroundHintRecipe,Vl as neutralForegroundHover,Tl as neutralForegroundRecipe,Dl as neutralForegroundRest,ma as neutralLayer1,fa as neutralLayer1Recipe,va as neutralLayer2,ba as neutralLayer2Recipe,xa as neutralLayer3,ya as neutralLayer3Recipe,wa as neutralLayer4,$a as neutralLayer4Recipe,ua as neutralLayerCardContainer,da as neutralLayerCardContainerRecipe,ga as neutralLayerFloating,pa as neutralLayerFloatingRecipe,Pc as neutralLayerL1,Mc as neutralLayerL2,Bc as neutralLayerL3,Nc as neutralLayerL4,sh as neutralOutlineActive,nh as neutralOutlineFocus,oh as neutralOutlineHover,ih as neutralOutlineRest,la as neutralPalette,Hl as neutralStrokeActive,Kr as neutralStrokeActiveDelta,jl as neutralStrokeControlActive,Zr as neutralStrokeControlActiveDelta,Ul as neutralStrokeControlFocus,Jr as neutralStrokeControlFocusDelta,Nl as neutralStrokeControlHover,Qr as neutralStrokeControlHoverDelta,Ml as neutralStrokeControlRecipe,Bl as neutralStrokeControlRest,Yr as neutralStrokeControlRestDelta,ql as neutralStrokeDividerRecipe,_l as neutralStrokeDividerRest,ta as neutralStrokeDividerRestDelta,Pl as neutralStrokeFocus,Xr as neutralStrokeFocusDelta,zl as neutralStrokeHover,Wr as neutralStrokeHoverDelta,Xl as neutralStrokeInputActive,Yl as neutralStrokeInputFocus,Kl as neutralStrokeInputHover,Gl as neutralStrokeInputRecipe,Wl as neutralStrokeInputRest,tc as neutralStrokeLayerActive,oa as neutralStrokeLayerActiveDelta,Jl as neutralStrokeLayerHover,ia as neutralStrokeLayerHoverDelta,Ql as neutralStrokeLayerRecipe,Zl as neutralStrokeLayerRest,ea as neutralStrokeLayerRestDelta,Al as neutralStrokeRecipe,Ll as neutralStrokeRest,Gr as neutralStrokeRestDelta,sc as neutralStrokeStrongActive,na as neutralStrokeStrongActiveDelta,nc as neutralStrokeStrongFocus,ra as neutralStrokeStrongFocusDelta,oc as neutralStrokeStrongHover,sa as neutralStrokeStrongHoverDelta,ec as neutralStrokeStrongRecipe,ic as neutralStrokeStrongRest,Du as numberFieldStyles,Ic as outlineWidth,Hu as progressRingStyles,Ou as progressStyles,Pp as provideFluentDesignSystem,Uu as radioGroupStyles,Gu as selectStyles,Xu as skeletonStyles,ep as sliderLabelStyles,Zu as sliderStyles,jn as strokeWidth,sp as switchStyles,dp as tabPanelStyles,lp as tabStyles,pp as tabsStyles,bp as textAreaStyles,$p as textFieldStyles,zp as treeItemStyles,Dp as treeViewStyles,_n as typeRampBaseFontSize,Gn as typeRampBaseLineHeight,Wn as typeRampMinus1FontSize,Kn as typeRampMinus1LineHeight,Xn as typeRampMinus2FontSize,Yn as typeRampMinus2LineHeight,Qn as typeRampPlus1FontSize,Zn as typeRampPlus1LineHeight,Jn as typeRampPlus2FontSize,tr as typeRampPlus2LineHeight,er as typeRampPlus3FontSize,ir as typeRampPlus3LineHeight,or as typeRampPlus4FontSize,sr as typeRampPlus4LineHeight,nr as typeRampPlus5FontSize,rr as typeRampPlus5LineHeight,ar as typeRampPlus6FontSize,lr as typeRampPlus6LineHeight};
